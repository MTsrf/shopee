...
class ProductView(View):
    def get(self, request):
        ...
        return render(request, 'home.html',{'topwears':topwears,'bottomwears':bottomwears,'mobiles':mobiles,'laptops':laptops})
...
def orders(request):
    ...
    return render(request, 'orders.html',{'orderplaced':op})
...
def laptop(request, dat=None):
    if dat == None:
        laptops =Product.objects.filter(category='L')
    elif dat == 'hp' or dat == 'dell' or dat == 'accer':
        laptops = Product.objects.filter(category='L').filter(brand=dat)
    elif dat == 'below':
...
def checkout(request):
    ...
    if cart_product:
        ...
        totalamount = amount + shipping_amount
    return render(request, 'checkout.html',{'add':add, 'totalamount':totalamount, 'cart_item':cart_items})
